...
par(mfrow=c(2,2))
plot(hpc_subset$Global_active_power ~ hpc_subset$DateTime, type="l", ylab="Global Active Power", xlab="")
plot(hpc_subset$Voltage ~ hpc_subset$DateTime, type="l", ylab="Voltage", xlab="datetime")
...
plot(hpc_subset$Global_reactive_power ~ hpc_subset$DateTime, type="l", ylab="Global_reactive_power", xlab="datatime")
